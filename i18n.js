const I18N = {
  en: {
    ...
    proj2_tag2: "Live Tool", proj2_title: "Live-Talk", proj2_desc: "Django Live Speech To text & text to Speech Web-base platform.",
    ...
    exp2_badge: "Old Days",
    exp2_title: "English Language Instructor", exp2_sub: "Self-employed",
    exp2_desc: "Taught 120+ students across all levels — specialized in IELTS preparation and business English with a 96% student retention rate over 4 years.",
  ...
  fa: {
    ...
    hero_badge: "آماده همکاری", hero_name: "مکس میلر",
    ...
    proj2_tag2: "جنگو", proj2_title: "Live-Talk", proj2_desc: "پلتفرم وب تبدیل گفتار به متن و متن به گفتار زنده با جنگو.",
    ...
    exp2_badge: "روزهای قدیم",
    exp2_title: "مدرس زبان انگلیسی", exp2_sub: "مستقل",
    exp2_desc: "تدریس به بیش از ۱۲۰ زبان‌آموز در تمام سطوح — با تخصص در آمادگی آزمون آیلتس و انگلیسی تجاری، با نرخ ماندگاری ۹۶٪ طی ۴ سال.",
