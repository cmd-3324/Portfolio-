const I18N = {
  en: {
    ...
    proj2_tag1: "PROJECT", proj2_title: "Your Second Project", proj2_desc: "Swap this card for your next real project. Same structure, new content.",
  ...
  fa: {
    ...
    proj2_tag1: "پروژه", proj2_title: "دومین پروژه شما", proj2_desc: "این کارت را با پروژه واقعی بعدی خود جایگزین کنید. همان ساختار، محتوای جدید.",
